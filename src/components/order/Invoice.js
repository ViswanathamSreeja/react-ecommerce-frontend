...
const Invoice = ({ order }) => (
    <Document>
        <Page style={styles.body}>
            ...
            <Text style={styles.title}>kjkghgfgd</Text>
            <Text style={styles.title}>Crazy Shopping</Text>
            ...
            <Text style={styles.text}>
                ...
                {"\n"}
                <text>
                    Order Id:{"           "}{order.paymentIntent._id}
                </text>
                {"\n"}
                <text>
                    Order Status:{"    "}{order.paymentIntent.status}
                </text>
                {"\n"}
                <text>
